          ...
          <div className="row align-items-center min-vh-75">
            <div className="col-lg-6">
              <Fade direction="up" delay={200}>
                <h1 className="display-4 fw-bold text-white mb-4 hero-title">
                  Travel Stories
                  <span className="d-block hero-subtitle">& Experiences</span>
                </h1>
                ...
                <div className="d-flex flex-wrap gap-3">
                  <Button
                    type="button"
                    className="btn btn-primary px-4 py-2 rounded-pill shadow-sm custom-btn-explore"
                    onClick={() =>
                      document
                  ...
                  <Button
                    type="button"
                    className="btn btn-outline-light px-4 py-2 rounded-pill custom-btn-share"
                    ...
                    <div className="story-card h-100 bg-white rounded-4 shadow-sm border-0 overflow-hidden">
                      ...
                      <div className="card-body p-4">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                          ...
                          <Button
                            type="button"
                            className="btn btn-sm text-white shadow-sm fw-bold"
                            style={{
